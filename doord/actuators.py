...
class PerleActuator(Actuator):
    ...
    def operate(self):
        # FIXME: PerleProtocol should probably have a .waitingForActivation() method
        if self.perle and self.perle.mode == "WaitForIssueActivationConfirmation" and self.d == None:
            self.perle.openDoor()
